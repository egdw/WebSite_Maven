...
//		System.out.println(parseObject);
    ...
    public void testImageCompress() {
        File path = new File("/home/hdy/Desktop/425942.png");
        File path2 = new File("/home/hdy/Desktop/2.jpg");
        try {
            BufferedImage bufferedImage = ImageIO.read(path);
            Thumbnails.of(bufferedImage).size(bufferedImage.getWidth(), bufferedImage.getHeight()).outputQuality(0.1f).toFile(path2);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
