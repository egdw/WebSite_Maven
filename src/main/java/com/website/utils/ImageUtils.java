...
public class ImageUtils {
	 ...
	 */
	public static void thumbnailImage(File imgFile, int w, int h, String prevfix,
			boolean force) {
		if (imgFile.exists()) {
			try {
				...
				ImageIO.write(bi, suffix,
						new File(p.substring(0, p.lastIndexOf(File.separator))
	...
	public static void thumbnailImage(String imagePath, int w, int h, String prevfix,
			boolean force) {
