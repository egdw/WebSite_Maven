...
public class WebSiteBlogService {
     ...
     * @return
     */
    public boolean addType(WebsiteBlogType blogType) {
        int i = typeMapper.insert(blogType);
     ...
     * @return
     */
    public boolean updateTypeId(WebsiteBlogType blogType) {
        int i = typeMapper.updateByPrimaryKey(blogType);
        return i > 0 ? true : false;
    }
}
