...
-- ----------------------------
BEGIN;
INSERT INTO `website_role` VALUES ('1', 'super_admin', '2017-02-21', '拥有所有的权限'), ('2', 'admin', '2017-02-21', '拥有部分权限'), ('3', 'normal', '2017-02-21', '拥有普通用户的所有权限');
COMMIT;
